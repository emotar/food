...
------------------------會員群組
INSERT INTO User_Group (name, description, cdate) VALUES ('管理員', '', '2017-03-14')
INSERT INTO User_Group (name, description, cdate) VALUES ('會員', '', '2017-03-14')
...
-------------------------指派會員與群組
INSERT INTO user_group_user  (user_group_id, user_id) VALUES (SELECT id FROM User_Group WHERE name = '管理員', SELECT id FROM User WHERE username = 'Jerry')
